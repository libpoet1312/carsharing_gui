...
export const PrivacyPolicy = () => {
    return (
        <div>
            <h1>Privacy Policy of https://carsharing1312.herokuapp.com/</h1>

            <p>{SITE_NAME} operates the https://carsharing1312.herokuapp.com/ website, which provides the SERVICE.</p>

            <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information
                if anyone decided to use our Service, the CarSharing website.</p>
            ...
            <p>The terms used in this Privacy Policy have the same meanings as in our <Link to={'/terms'}>Terms and Conditions</Link>,
            ...
            <p>For a better experience while using our Service, we may require you to provide us with certain personally identifiable information,
                including but not limited to your name, phone number, email, gender, country. The information that we collect will be used to contact or identify you.
            </p>
            ...
            <p>We want to inform you that whenever you visit our Service, we collect information that your browser sends to us that is called Log Data.
                This Log Data may include information such as your computer’s Internet Protocol ("IP") address, browser version,
                pages of our Service that you visit, the time and date of your visit, the time spent on those pages, and other statistics.
            </p>

            <h2>Cookies</h2>
            <p>{SITE_NAME} <strong>DOES NOT</strong> make use of any cookies.</p>
            <p>
                {SITE_NAME} uses local storage that HTML5 technology provides each browser to store necessary user data,
                for the simplification of functions on certain areas on our website.
                These stored attributes help you, for example, not to log in every time you visit our website, but to log in only once.
            </p>
            ...
            <p>Our Services do not address anyone under the age of 18. We do not knowingly collect personal identifiable information from children under 18.
            ...
            <p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us. on {SITE_EMAIL}</p>
        </div>
    )
};
