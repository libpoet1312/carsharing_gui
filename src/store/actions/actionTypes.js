...
// PROFILE SETTINGS ACTIONS | UPDATE PROFILE
...
// MY RIDES ACTIONS
export const FETCH_MY_RIDES_START = 'FETCH_MY_RIDES_START';
export const FETCH_MY_RIDES_FAIL = 'FETCH_MY_RIDES_FAIL';
export const FETCH_MY_RIDES_SUCCESS = 'FETCH_MY_RIDES_SUCCESS';

export const DELETE_MY_RIDE_START = 'DELETE_MY_RIDE_START';
export const DELETE_MY_RIDE_FAIL = 'DELETE_MY_RIDE_FAIL';
export const DELETE_MY_RIDE_SUCCESS = 'DELETE_MY_RIDE_SUCCESS';

export const UPDATE_MY_RIDE_START = 'UPDATE_MY_RIDE_START';
export const UPDATE_MY_RIDE_FAIL = 'UPDATE_MY_RIDE_FAIL';
export const UPDATE_MY_RIDE_SUCCESS = 'UPDATE_MY_RIDE_SUCCESS';
...
// MY SINGLE RIDE ACTIONS
export const FETCH_MY_RIDE_START = 'FETCH_MY_RIDE_START';
export const FETCH_MY_RIDE_FAIL = 'FETCH_MY_RIDE_FAIL';
export const FETCH_MY_RIDE_SUCCESS = 'FETCH_MY_RIDE_SUCCESS';
